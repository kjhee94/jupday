...
/**
 * Servlet implementation class CrewJoinRefusalServlet
 */
@WebServlet("/crew/crewJoinRefusal.do")
public class CrewJoinRefusalServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CrewJoinRefusalServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = cService.updateCrewJoinStateRefusal(userId, crewNo);
		
		RequestDispatcher view = request.getRequestDispatcher("/views/crew/crewJoinApproveRefusal.jsp");
