...
public class AdminCrewFeedServiceImpl implements AdminCrewFeedService{
   ...
   @Override
   public HashMap<String, Object> selectAllCrewFeedPageList(int currentPage, int crewNo) {
      ...
      String pageNavi = adcfDAO.getFeedPageNavi(conn,naviCountPerPage,recordCountPerPage,currentPage,crewNo);
