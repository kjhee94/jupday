...
/**
 * Servlet implementation class CampaignAllSelectServlet
 */
@WebServlet("/notice/noticeCampaignAllSelect.do")
public class CampaignAllSelectServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CampaignAllSelectServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    HashMap <String,Object> pageDataMap = NService.selectAllCampaignPostList(currentPage);
