...
/**
 * Servlet implementation class NoticeFAQAllSelectServlet
 */
@WebServlet("/notice/noticeFAQSelect.do")
public class NoticeFAQAllSelectServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public NoticeFAQAllSelectServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	               ...
	               //해당 Servlet을 요청하게 되면, 페이지 값을 받아와서 동작하는 형태로 구현 할 것입니다.
				    ...
				    HashMap <String,Object> pageDataMap = NService.selectAllFAQList(currentPage);
