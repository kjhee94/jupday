		...
		<div id="content">
			<div class="user-info">
				...
				<table class="info">
					<tr>
						<td>비밀번호</td>
						<td><input type="password" class="input-style" placeholder="비밀번호를 입력하세요."></td>
					</tr>
					<tr>
						<td>비밀번호 확인</td>
						<td><input type="password" class="input-style" placeholder="비밀번호를 입력하세요."></td>
					...
					<tr>
						<td colspan="2">
							...
							<p> - 사용하고 계신 아이디(%=userId %)는 탈퇴할 경우 재사용 및 복구가 불가능합니다. <br>
							 - 탈퇴 후 회원정보 및 개인형 서비스 이용기록은 모두 삭제됩니다.<br>
							 - 각종 게시판의 게시글, 댓글 등의 데이터는 삭제되지 않습니다. 반드시 탈퇴 전 직접 삭제하셔야 합니다. <p> <br>
							<input type="checkbox"> <span>안내사항을 모두 확인하였으며, 이에 동의합니다.</span>
						</td>
					</tr>
				</table>
