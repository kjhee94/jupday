...
<title>관리자페이지 - 캠페인 안내 관리 : 글쓰기 </title>
				...
				<form action="">
					<div class="box-write">
						<div class="box-subject">
							<input type="text" placeholder="제목을 입력하세요" value="★한강 플로깅 안내★">
						</div>
						<div class="box-content">
							<textarea placeholder="내용을 입력하세요">겨울에도 지치지않는 플로깅의 열기, 한강에서 시작합니다.</textarea>
						</div>
