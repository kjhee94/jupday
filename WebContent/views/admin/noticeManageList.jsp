...
<body>
   ...
   <%//페이징 처리 된 데이터 가져오기
      ...
      ArrayList<AdminNotice> list = (ArrayList<AdminNotice>)pageDataMap.get("list");
                    ...
                    <div class="box-search">
                    	<div class="btn-write">
							<button class="btn-rec">
								<a href="/views/admin/noticeWrite.jsp" method="post">글쓰기</a>
							</button>
						</div>
                ...
                <div class="table_wrap">
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td><%=an.getN_No() %></td>
                                <td><div class="text-ellipsis w-300"><%=an.getN_Title() %></div></td>
                                <td><div class="text-ellipsis w-400"><%=an.getN_Content() %></div></td>
